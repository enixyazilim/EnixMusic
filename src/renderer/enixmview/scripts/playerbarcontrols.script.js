...
(function () {
  ...
  libraryButton.classList.add("enixm-player-bar-control");
  ...
  playlistButton.classList.add("enixm-player-bar-control");
  ...
  sleepTimerButton.classList.add("enixm-player-bar-control");
                    ...
                    items: [
                      {
                        menuServiceItemRenderer: {
                          ...
                          serviceEndpoint: {
                            enixmSleepTimerServiceEndpoint: {
                              time: 5
                            }
                          },
                          text: {
  ...
  window.addEventListener("yt-action", e => {
    if (e.detail.actionName === "yt-service-request") {
      if (e.detail.args[1].enixmSleepTimerServiceEndpoint) {
        ...
        if (e.detail.args[1].enixmSleepTimerServiceEndpoint.time > 0) {
          if (!sleepTimerButton.classList.contains("active")) {
            sleepTimerButton.classList.add("active");
            sleepTimerButton.setAttribute("title", `Sleep timer ${humanizeTime(e.detail.args[1].enixmSleepTimerServiceEndpoint.time)}`);
          }
                      ...
                      popup: {
                        notificationActionRenderer: {
                          responseText: {
                            runs: [
                              {
                                text: `Sleep timer set to ${humanizeTime(e.detail.args[1].enixmSleepTimerServiceEndpoint.time)}`
                              }
                            ]
                          }
                        }
          ...
          sleepTimerTimeout = setTimeout(
            ...
            e.detail.args[1].enixmSleepTimerServiceEndpoint.time * 1000 * 60
          );
        } else {
          document.body.dispatchEvent(
            new CustomEvent("yt-action", {
